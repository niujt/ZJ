...
public class QuestionController {
    ...
    public ModelAndView getQuesList(HttpServletRequest request){
        request.setAttribute("questions",service.getQuestionCounts());
        return new ModelAndView("admin/QuestionManagement");
    }
    ...
    public ModelAndView questionInfo(HttpServletRequest request, @PathVariable String type,@RequestParam(value = "currentPage",required = false)Integer currentPage){
        if(currentPage==null){
            currentPage=1;
        }
        ...
        if(type.equals("选择题")){
            ...
            return new ModelAndView("admin/info/ApplicationquestionInfo");
        }
      else{
            return new ModelAndView("admin/info/OtherInfo");
        }
    }
